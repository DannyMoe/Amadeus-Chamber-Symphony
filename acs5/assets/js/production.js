 ...
 * Build: http://modernizr.com/download/#-fontface-borderradius-opacity-textshadow-cssanimations-cssgradients-csstransitions-input-inputtypes-shiv-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes-load
 */
;
...
jQuery(function() {
    ...
    /* Device State */
    if (getDeviceState() == 'tablet' || getDeviceState() == 'small-desktop' || getDeviceState() == 'desktop') {
    ...
    nextEvent = new Date(2014, 5 - 1, 2, 20);
    $('#clock').countdown({
        until: nextEvent,
        format: 'odHMS'
    });
    /* End Progam Countdown */
...
$('.content img').on('click', function(e) {
    ...
    var currentImg = $('.photoStage').children();
    $('.photoStage').html('');
    $('.photoStage').html(img);
});
