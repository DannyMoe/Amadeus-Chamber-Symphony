...
<body class="full">
    ...
    <div class="container full">
        ...
        <h1 class="heading">Welcome, <?php echo $username ?>!</h1>

        <section class="content">
          <h2>Amadeus Event Calendar</h2>
            <div id="calendar"></div>
            <div id="meetingForm">
              <form id="uploadForm" action="upload.php?name=<?php echo $username ?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="MAX_FILE_SIZE" value="2000000">
                <label>Upload Meeting Minutes:</label>
                <input type="file" name="meetingFile">
                <input type="submit" name="upload" id="upload" class="fileSubmit" value="Upload">
              </form>
            </div>
            <div id="meetingResults">
              <h3>Click on a file name to view the file:</h3>
